...
from rho_stats import measure_tau_mpi, write_stats, write_stats_tau, plot_overall_tau
...
patch_fn = '/global/cfs/cdirs/des/y6-shear-catalogs/patches-centers-altrem-npatch200-seed9999.fits'
